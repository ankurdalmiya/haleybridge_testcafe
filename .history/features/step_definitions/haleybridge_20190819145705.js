...
When(/^I look for "([^"]*)" in "([^"]*)"$/, async function(text1, text2) {
    await testController.typeText(haleyPage.haleywebsite.searchTextBox2(), text1);
    await testController.typeText(haleyPage.haleywebsite.searchLocation(), searchTextBox2);
